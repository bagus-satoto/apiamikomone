...
exports.default = {
    ...
    */
    Qrcode: async (bearerToken, data) => {
        try {
            await source_1.default.post("https://ds.amikom.ac.id/api/amikomone/presensi_mobile/validate_qr_code", {
                headers: {
    ...
    */
    Code: async (bearerToken, code) => {
        try {
            await source_1.default.post("https://ds.amikom.ac.id/api/amikomone/presensi_mobile/validate_ticket", {
                headers: {
                    "Authorization": `Bearer ${bearerToken}`,
                    "content-type": Headers_1.ContentType.Json
                },
     ...
     * Rekap Presensi
     */
    All: (bearerToken, xApiKey, semester, tahunAkademik) => source_1.default.post("https://ds.amikom.ac.id/api/amikomone/academic/presensi/rekap", {
        headers: {
            Authorization: `Bearer ${bearerToken}`,
            'X-Api-Key': xApiKey,
     ...
     */
    Detail: (bearerToken, xApiKey, krsId) => source_1.default.post("https://ds.amikom.ac.id/api/amikomone/academic/presensi/kuliah", {
        headers: {
            Authorization: `Bearer ${bearerToken}`,
            'X-Api-Key': xApiKey,
            "content-type": Headers_1.ContentType.FormEncoded
